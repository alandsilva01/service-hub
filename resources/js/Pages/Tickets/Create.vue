...
const submit = () => form.post(route('tickets.store'));

// Efeito reflexo seguindo o mouse
const card = ref(null);
...
/* Label sobe quando preenchido ou focado */
